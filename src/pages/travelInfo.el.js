      ...
      <Layout language="el" location={this.props.location}>
        ...
        <div className={contentStyles.content}>
          ...
          <p>
            ...
            είναι το φθηνότερο μέσο μεταφοράς εντός της πόλης και όλων των
            πόλεων στη Σερβία. Οι τακτικές γραμμές λεωφορείων συνδέουν το
            Βελιγράδι με όλα τα μέρη της Σερβίας, ενώ οι διεθνείς γραμμές
          ...
          <p>
            ...
            θα πρέπει να πληρώσετε πολλά διόδια μέχρι να φτάσετε στο Βελιγράδι.
            ...
            λεπτομερή χάρτη μαζί σας. Τα όρια ταχύτητας είναι σύμφωνα με τα
          ...
          <p>
            ...
            Ισραήλ, Λετονία, Λιχτενστάιν, Λιθουανία, Λουξεμβούργο, Μακεδονία,
            Μάλτα, Μονακό, Ολλανδία, Νορβηγία, Πολωνία , Πορτογαλία, Ρουμανία,
            Ρωσική Ομοσπονδία, Άγιος Μαρίνος, Σλοβακία, Σλοβενία, Ισπανία,
            Ελβετία, Σουηδία, ΗΠΑ, Βατικανό.
          </p>
          <p>
          ...
          <p>
            Το αεροδρόμιο είναι καλά συνδεδεμένο με το κέντρο της πόλης μέσω της
            γραμμής λεωφορείου 72 της δημόσιας συγκοινωνίας (GSP). Το ταξίδι με
          ...
          <p>
            ...
            εισιτήρια (BUS PLUS) για περισσότερα δρομολόγια μπορούν να βρεθούν
            στα καταστήματα, με τη μία διαδρομή να κοστίζει 89 δηνάρια (περίπου
            0,90 €). Το ημερήσιο ηλεκτρονικό εισιτήριο κοστίζει 250 δηνάρια
            (περίπου 2,50 €).
          </p>
          <p>
          ...
          <p>
            ...
            να φτάσετε στο σχολείο με κάποιο τρόλεϊ ή λεωφορείο (αριθμός 31, 29,
            E9).
          </p>
          <p>
            Τα εισιτήρια μπορείτε να τα αγοράσετε στο λεωφορείο από τον οδηγό
          ...
          <p>
            ...
            σταθμό (Zeleni venac) και μετά περπατήστε περίπου 10 λεπτά, όπως ήδη
            εξηγήθηκε στον χάρτη.
          </p>
          <p>
            Τα εισιτήρια μπορείτε να τα αγοράσετε στο λεωφορείο από τον οδηγό
            και κοστίζουν 150 δηνάρια (περίπου 1,50 €). Επιπλέον, τα ηλεκτρονικά
