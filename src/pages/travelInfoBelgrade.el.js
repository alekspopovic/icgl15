    ...
    return (
      <Layout language="el" location={this.props.location}>
        ...
        <div className={contentStyles.content}>
          ...
          <p>
            Οι συμμετέχοντες παρακαλούνται να επικοινωνήσουν με τη Σερβική
            Πρεσβεία ή το Προξενικό Γραφείο στη χώρα τους και να υποβάλουν
            αίτηση για θεώρηση εισόδου, σε περίπτωση που αυτή είναι απαραίτητη.
            Οι λεπτομέρειες της διαδικασίας μπορεί να ποικίλλουν, αλλά μπορεί να
            σας ζητηθεί να παράσχετε ορισμένα από τα ακόλουθα έγγραφα: επιστολή
            πρόσκλησης από έναν Σέρβο κάτοικο ή οργανισμό, απόδειξη από το μέρος
            διαμονής (π.χ. ξενοδοχείο), ιατρική ασφάλιση, απόδειξη τραπεζικού
            λογαριασμού ή πιστωτικής κάρτας, απόδειξη απασχόλησης ή φοίτησης,
            αντίγραφο εισιτηρίου μετ’ επιστροφής ή φωτογραφίες.
          </p>
          <p>
